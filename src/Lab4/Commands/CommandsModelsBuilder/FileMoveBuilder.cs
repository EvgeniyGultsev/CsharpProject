...
public class FileMoveBuilder
{
    ...
    public FileMoveBuilder WithSourcePath(string path)
    {
    ...
    public FileMoveBuilder WithDestinationPath(string path)
    {
        _destinationPath = path;
        return this;
    }

    public FileMoveModel Build()
    {
        return new FileMoveModel(
