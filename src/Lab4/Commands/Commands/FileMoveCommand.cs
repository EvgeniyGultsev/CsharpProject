...
{
    private readonly FileMoveModel _data;

    public FileMoveCommand(FileMoveModel data)
    {
        _data = data;
    }
    ...
    public CommandExecutingResult Execute(IContext context)
    {
        ...
        if (context.System.Move(sourcePath, endPath) is ResultSystemOperation.Success)
